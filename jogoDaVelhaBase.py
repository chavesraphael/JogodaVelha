...
def jogadaMaquina(tabuleiro, jogada):
    ...
    if jogada == 1:
        ...
        #1 - OK
        if tabuleiro["B"][1] == "O": tabuleiro["C"][2] = "X"

        #2 - OK
        if tabuleiro["C"][0] == "O": tabuleiro["A"][2] = "X"
        
        #3 - OK
        if tabuleiro["A"][2] == "O": tabuleiro["C"][2] = "X"

        #4 - OK
        if tabuleiro["A"][1] == "O": tabuleiro["C"][0] = "X"

        #5 - OK
        if tabuleiro["B"][2] == "O": tabuleiro["C"][0] = "X"
        
        #6 - OK
        if tabuleiro["B"][0] == "O": tabuleiro["A"][2] = "X"

        #7
        if tabuleiro["C"][1] == "O": tabuleiro["A"][2] = "X"

        if tabuleiro["C"][2] == "O": tabuleiro["B"][1] = "X"
        
    
    elif jogada==3:
    
        #1-1
        if tabuleiro["B"][1] == "O" and tabuleiro["C"][2] == "X" and tabuleiro["C"][0] == "O":
            tabuleiro["A"][2] = "X"
        
        #2-1
        if tabuleiro["C"][0] == "O" and tabuleiro["A"][2] == "X" and tabuleiro ["A"][1] == "O":
            tabuleiro["C"][2] = "X"
        
        #3-1
        if tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X" and tabuleiro["B"][1] == "O":
            tabuleiro["C"][0] = "X"
        
        #4-1
        if tabuleiro["A"][1] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["B"][0] == "O":
            tabuleiro["C"][2] = "X"

        #5-1
        if tabuleiro["B"][2] == "O" and tabuleiro["C"][0] == "X" and tabuleiro["B"][0] == "O":
            tabuleiro["B"][1] = "X"

        #6-1
        if tabuleiro["B"][0] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O":
            tabuleiro["B"][1] = "X"
        
        #7-1
        #if tabuleiro["C"][1] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O":

    elif jogada==4:
        
        #1-1-1
        if tabuleiro["B"][1] == "O" and tabuleiro["C"][2] == "X" and tabuleiro["C"][0] == "O" and \
           tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O":

            tabuleiro["B"][2] = "X"
        
        #1-1-2
        elif tabuleiro["B"][1] == "O" and tabuleiro["C"][2] == "X" and tabuleiro["C"][0] == "O" and \
           tabuleiro["A"][2] == "X" and (tabuleiro["B"][2] == "O" or tabuleiro["B"][0] == "O" or tabuleiro["C"][1] == "O"):

            tabuleiro["A"][1] = "X"
        
        #2-1-1
        elif tabuleiro["C"][0] == "O" and tabuleiro["A"][2] == "X" and tabuleiro ["A"][1] == "O"and \
            tabuleiro["C"][2] == "X" and tabuleiro["B"][2] == "O":

            tabuleiro["B"][1] = "X"
        
        #2-1-2
        elif tabuleiro["C"][0] == "O" and tabuleiro["A"][2] == "X" and tabuleiro ["A"][1] == "O"and \
            tabuleiro["C"][2] == "X" and (tabuleiro["B"][1] == "O" or tabuleiro["C"][1] == "O" or tabuleiro["B"][0] == "O"):
        
            tabuleiro["B"][2] = "X"

        #3-1-1
        elif tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X" and tabuleiro ["B"][1] == "O" and \
            tabuleiro["C"][0] == "X" and (tabuleiro["C"][1] == "O" or tabuleiro["B"][2] == "O" or tabuleiro["A"][1] == "O"):

            tabuleiro["B"][0] = "X"

        #3-1-2
        elif tabuleiro["A"][2] == "O" and tabuleiro["C"][2] == "X" and tabuleiro ["B"][1] == "O" and \
            tabuleiro["C"][0] == "X" and tabuleiro["B"][0] == "O":

            tabuleiro["C"][1] = "X"
        
        #4-1-1
        elif tabuleiro["A"][1] == "O" and tabuleiro["C"][0] == "X" and tabuleiro ["B"][0] == "O" and \
            tabuleiro["C"][2] == "X" and (tabuleiro["B"][1] == "O" or tabuleiro["B"][2] == "O" or tabuleiro["A"][2] == "O"):
            
            tabuleiro["C"][1] = "X"

        #4-1-2
        elif tabuleiro["A"][1] == "O" and tabuleiro["C"][0] == "X" and tabuleiro ["B"][0] == "O" and \
            tabuleiro["C"][2] == "X" and tabuleiro["C"][1] == "O":
            
            tabuleiro["B"][1] = "X"

        #5-1-1
        elif tabuleiro["B"][2] == "O" and tabuleiro["C"][0] == "X" and tabuleiro ["B"][0] == "O" and \
            tabuleiro["B"][1] == "X" and (tabuleiro["A"][1] == "O" or tabuleiro["A"][2] == "O" or tabuleiro["C"][1] == "O"):

            tabuleiro["C"][2] = "X"

        #5-1-2
        elif tabuleiro["B"][2] == "O" and tabuleiro["C"][0] == "X" and tabuleiro ["B"][0] == "O" and \
            tabuleiro["B"][1] == "X" and tabuleiro["C"][2] == "O":

            tabuleiro["A"][2] = "X"
        
        #6-1-1
        elif tabuleiro["B"][0] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and \
            tabuleiro["B"][1] == "X" and (tabuleiro["B"][2] == "O" or tabuleiro["C"][2] == "O" or tabuleiro["C"][1] == "O"):

            tabuleiro["C"][0] = "X"

        #6-1-2
        elif tabuleiro["B"][0] == "O" and tabuleiro["A"][2] == "X" and tabuleiro["A"][1] == "O" and \
            tabuleiro["B"][1] == "X" and tabuleiro["C"][0] == "O":
